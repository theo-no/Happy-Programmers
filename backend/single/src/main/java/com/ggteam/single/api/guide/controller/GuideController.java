...
public class GuideController {
	...
	public ResponseEntity<List<MonsterDto>> monsterSearchList(@RequestParam("keyword") String keyword) {
		List<MonsterDto> responseDto = monsterService.findAllByName(keyword);
		return new ResponseEntity<>(responseDto, HttpStatus.OK);
	}
	...
	public ResponseEntity<List<SkillDto>> skillSearchList(@RequestParam("keyword") String keyword) {
		List<SkillDto> responseDto = skillService.findAllByName(keyword);
		return new ResponseEntity<>(responseDto, HttpStatus.OK);
	}
	...
	public ResponseEntity<List<ItemDto>> itemSearchList(@RequestParam("keyword") String keyword) {
		List<ItemDto> responseDto = itemService.findAllByName(keyword);
		return new ResponseEntity<>(responseDto, HttpStatus.OK);
	}
	...
	public ResponseEntity<List<LevelDto>> levelList() {
		List<LevelDto> responseDto = levelService.findAll();
		return new ResponseEntity<>(responseDto, HttpStatus.OK);
	}
}
